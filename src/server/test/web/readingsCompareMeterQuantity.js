		...
		() => {
			mocha.describe("for compare charts", () => {
				mocha.describe("for meters", () => {
					...
					mocha.it(
						"C1: 1 day shift end 2022-10-31 17:00:00 for 15 minute reading intervals and quantity units & kWh as kWh",
						async () => {
					...
					mocha.it(
						"C2: 7 day shift end 2022-10-31 17:00:00 for 15 minute reading intervals and quantity units & kWh as kWh",
						async () => {
							await prepareTest(unitDatakWh, conversionDatakWh, meterDatakWh);
							// Get the unit ID since the DB could use any value.
							const unitId = await getUnitId("kWh");
					...
					mocha.it(
						"C3: 28 day shift end 2022-10-31 17:00:00 for 15 minute reading intervals and quantity units & kWh as kWh",
						async () => {
							await prepareTest(unitDatakWh, conversionDatakWh, meterDatakWh);
							// Get the unit ID since the DB could use any value.
							const unitId = await getUnitId("kWh");
